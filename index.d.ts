...
declare namespace PayjpJs {
	...
	export type StyleCssPseudoBody = {
		[key in StyleCssPseudoKey]?: StyleCssBody;
	};
	export type StyleObject = {
		[key in StyleInputStatus]?: StyleCssBody & StyleCssPseudoBody;
	};
	...
	export type ElementEventListenerOnReady = (
		event: "ready",
		listener: (e: { elementType: TypeField }) => void,
	) => void;
	export type ElementEventListenerOnFocus = (
		event: "focus",
		listener: (e: { elementType: TypeField }) => void,
	) => void;
	export type ElementEventListenerOnBlur = (
		event: "blur",
		listener: (e: { elementType: TypeField }) => void,
	) => void;
	...
	export interface Payjp {
		...
		retrieveAvailability: (options?: {
			...
			Partial<PayjpError> & {
				card_types_supported: Array<CardBrand>;
				livemode: boolean;
			}
		>;
